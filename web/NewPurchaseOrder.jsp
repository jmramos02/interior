            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-heading">
							<div class="form-inline">
								...
								<!--<label align="pull-right">Purchase Order Number:12345 (AUTO GENERATED)</label>-->
                            </div>
                        </div>
                                ...
                                <div class="col-lg-6">
                                    <form role="form">
										 <div class="form-group">
                                            <label>Ordered By : AUTOMATIC</label>
                                        </div>
										<div class="form-group">
                                            <label>Purchase From:</label>
                                            <select class="form-control">
                                                <option>T.K Commercial</option>
                                                <option>ICS Carpentry Shop</option>
                                                <option>Mega Trade</option>
                                            </select>
                                        </div>
                    ...
                    <!-- /.panel -->
										...
										<div align = "right">
                                                                                       <button type="button" id="addProduct" class="btn btn-primary active" onclick="clicked()">Update Purchase Order</button>
